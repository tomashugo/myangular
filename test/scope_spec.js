...
describe("Scope", function () {
  ...
  describe("digest", function () {
    ...
    it("triggers chained watchers in the same digets", function () {
      scope.name = "Jane";
    ...
    it("compares bases on value if enabled", function () {
      scope.aValue = [1, 2, 3];
      scope.counter = 0;
...
describe("$eval", function () {
  ...
  it("passes the second $eval argumento straight through", function () {
    scope.aValue = 42;
...
describe("$watchGroup", function () {
  ...
  describe("inheritance", function () {
    it("inherits the paret's properties", function () {
    ...
    it("doest not cause a parent to inhert its properties", function () {
      var parent = new Scope();
    ...
    it("can manipulate a parente scopes property", function () {
      var parent = new Scope();
      var child = parent.$new();
      parent.aValue = [1, 2, 3];
    ...
    it("does not have access to parent attributs when isolated", function () {
      var parent = new Scope();
    ...
    it("executes $applyAsync function on isolated scopes", function () {
      var parent = new Scope();
      var child = parent.$new(true);
      var applied = false;
...
describe("$watchCollection", function () {
  ...
  it("works like a normal watch form NaNs", function () {
    scope.aValue = 0 / 0;
    scope.counter = 0;
  ...
  it("gives the old non-colletion value to its listeners", function () {
    scope.aValue = 42;
    var oldValueGiven;
  ...
  it("gives the old array value to its listeners", function () {
    scope.aValue = [1, 2, 3];
    var oldValueGiven;
...
describe("Events", function () {
  ...
  it("does not propagate to parens then stoped", function () {
    var scopeListener = function (event) {
